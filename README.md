...
| Claude Desktop | Upload the [release zip](https://github.com/tracerman/cheapcharts-skill/releases/download/v2.3.2/cheapcharts-claude-desktop.zip) via Settings > Features > Skills |
...
**Claude Desktop** requires a Pro/Max/Team/Enterprise plan with code execution enabled. Download [`cheapcharts-claude-desktop.zip`](https://github.com/tracerman/cheapcharts-skill/releases/download/v2.3.2/cheapcharts-claude-desktop.zip), then Settings > Features > Skills > Upload.
