...
1. Download [`cheapcharts-claude-desktop.zip`](https://github.com/tracerman/cheapcharts-skill/releases/latest) from the latest release
...
| Claude Desktop (upload) | Download zip from [releases](https://github.com/tracerman/cheapcharts-skill/releases/latest), upload via Settings > Features > Skills |
